...
export default function MenuItem({ to, title, icon }) {
  ...
  return (
    <button
      ...
      className="group relative rounded-2xl bg-indigo-50/50 hover:bg-indigo-50 p-4 lg:p-6 pt-6 lg:pt-10 lg:w-42 max-w-42 duration-100 cursor-pointer"
    >
      <FontAwesomeIcon
        icon={faSortUp}
        className="absolute text-3xl rotate-45 top-8 right-8 group-hover:top-4 group-hover:right-3 text-gray-100 group-hover:text-[#7A6DFF] duration-100 opacity-0 hover:opacity-100"
      />
