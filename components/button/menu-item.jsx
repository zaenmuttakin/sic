...
export default function MenuItem({ to, title, icon }) {
  ...
  return (
    <button
      ...
      className="group relative rounded-2xl bg-indigo-50/50 hover:bg-indigo-50 p-4 lg:p-6 pt-6 lg:pt-10 lg:w-42 max-w-42 duration-150 cursor-pointer"
    >
      <FontAwesomeIcon
        icon={faSortUp}
      ...
      <p className="text-sm font-medium lg:text-md text-left text-black group-hover:text-[#7A6DFF] duration-150">
        {title}
      </p>
    </button>
  );
